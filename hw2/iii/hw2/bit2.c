...
/*
 *	This struct is used to store the width and the height of the 2-d bit
 *	array
 */
struct T {
	int width;	/* The width of the 2-d bit array.*/
	int height;     /* The height of the 2-d bit array.*/
	Bit_T bit;      /* The 1-d bit array for the 2-d bit array*/
};
